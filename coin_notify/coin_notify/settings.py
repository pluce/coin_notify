"""
Django settings for coin_notify project.
...
SECRET_KEY = '7!27qsd6kt+58gvrakwilbn8d8j1n#4_b(s!avq6yuf=j(_1wh'
...
WSGI_APPLICATION = 'coin_notify.wsgi.application'
